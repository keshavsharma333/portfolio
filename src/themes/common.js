...
export default {
  ...
  mixins,
  // Add these new properties for the Experience component
  colors: {
    green: '#5FC921', // Using the accent color as green
    lightSlate: '#a8b2d1', // You can adjust this color as needed
  },
  fonts: {
    SFMono: 'Space Mono, SF Mono, Fira Code, Fira Mono, Roboto Mono, monospace',
  },
};
